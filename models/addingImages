...
image = open(r'C:\CSProject\sad_Selfie_gs.jpg', 'rb').read()
encodedImage = base64.b64encode(open(r'C:\CSProject\sad_Selfie_gs.jpg', 'rb').read())
#emotion = base64.b64encode('0')
#training = base64.b64encode('Training')
...
with open(r'C:\CSProject\fer2013.csv', 'w') as csvfile:
