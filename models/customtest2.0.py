...
#loading image
full_size_image = cv2.imread("test_images/Angry2.jpg")
print("Image Loaded")
...
temp = emotion_confidence.tolist();
for index in range(len(emotion_confidence)):
	print("Emotion: " + labels[temp[index]])
